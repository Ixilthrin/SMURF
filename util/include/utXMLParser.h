...
A modified version of Frank Vanden Berghen's XMLParser library extraced from Horde3D.
*/
 ...
 ****************************************************************************
 */
#ifndef _utXMLParser_H_
#define _utXMLParser_H_
...
typedef struct XMLDLLENTRY XMLNode
{
  ...
  public:
    ...
    XMLCSTR getAttribute(XMLCSTR name, const char *defValue) const;
