...
GuiImage *GLGuiImageCreator::createGuiImage(GuiImageInfo *info)
{
    ...
    Vertex1 *vertices = new Vertex1[4];
    ...
    VertexBufferInfo *vbInfo = new VertexBufferInfo(VertexBufferInfo::VERTEX1, 4);
